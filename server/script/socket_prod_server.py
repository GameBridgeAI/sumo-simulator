    ...
    while True:
        ...
        if len(data) > 0:
            ...
            if decoded == ' ':
                ...
                for key in cmd.keys():
                    if key == 'move_forward':
                        main_service.wheel_controller.handle_move_forward_cm(cmd[key][0], cmd[key][1])
                    elif key == 'test':
                        main_service.wheel_controller.handle_turn_left_degrees(cmd[key][0], cmd[key][1])